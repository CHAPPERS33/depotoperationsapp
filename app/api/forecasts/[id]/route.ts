...
export async function PUT(request: Request, { params }: RouteParams) {
  ...
  try {
    const body: Partial<Omit<Forecast, 'id' | 'createdAt' | 'updatedAt' | 'pay_period_info'>> & { volumes?: Array<Omit<ForecastVolume, 'id' | 'forecast_id' | 'sub_depot_name'>> } = await request.json();
